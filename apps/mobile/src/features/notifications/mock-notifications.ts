...
export const MOCK_NOTIFICATIONS: AppNotification[] = [
  mock('order:JP-260714-0001:ready', 'order_ready', 'Order ready for pickup', 'Your order is ready — head to the branch!', { orderId: 'JP-260714-0001' }, 2, false),
  mock('order:JP-260714-0001:preparing', 'order_preparing', 'Order being prepared', 'The kitchen is preparing your order.', { orderId: 'JP-260714-0001' }, 12, true),
  mock('order:JP-260714-0001:accepted', 'order_accepted', 'Order accepted', 'Your order has been accepted and is queued.', { orderId: 'JP-260714-0001' }, 18, true),
  mock('order:JP-260714-0002:cancelled', 'order_cancelled', 'Order cancelled', 'Your order was cancelled.', { orderId: 'JP-260714-0002' }, 30, true),
  mock('deal:deal-welcome-20', 'new_deal', 'New deal: Welcome 20% Off', 'Enjoy 20% off your first order.', { dealId: 'deal-welcome-20' }, 45, false),
  mock('coupon:coupon-fries-free', 'coupon_expiring', 'Coupon expiring soon', 'Your coupon "Free Classic Fries" is about to expire.', { couponId: 'coupon-fries-free' }, 90, false),
  mock('stars:5', 'one_more_order', 'One more order!', 'Just one more order to unlock your reward.', undefined, 150, true),
  mock('reward:reward-unlock-001', 'reward_unlocked', 'Reward unlocked!', 'You unlocked a free upgrade — enjoy!', undefined, 240, true),
  mock('promo:promo-bgc-launch', 'branch_promo', 'BGC branch is now open', 'Visit our new BGC branch for launch-week treats.', { promoId: 'promo-bgc-launch' }, 360, true),
];
