...
/**
 * Terms & Privacy top-level stack. Reached via `router.push('/(tabs)/terms')` —
 ...
 * as `(tabs)/notifications` and `(tabs)/history`, and renders the same combined
 * copy as the pre-auth `(auth)/terms` screen (shared `features/legal` content).
 *
