...
/**
 * Order History top-level stack. Reached via `router.push('/(tabs)/history')` —
 ...
 * Account), and the Order tab is never left mounted on Order History (NAV-005).
 *
 * Order History is reachable from BOTH the Account tab and the Order tab, which
 * is exactly what the ownership rule says must live above the tabs: a tab's
 ...
 * own content and owns its own top safe-area inset (see `./index.tsx`).
 */
